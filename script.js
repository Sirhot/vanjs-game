window.addEventListener("load", function () {
    ...
    class Particle {
        ...
        update() {
            ...
            if (this.y > this.game.height + this.size || this.x < 0 - this.size) this.markedForDelection = true
    ...
    class Player {
        ...
        update(deltaTime) {
            ...
            //vertical boundaries
            //if this.y goes below 400th px, equal it to 400th px
            if (this.y > this.game.height - this.height * 0.5) this.y = this.game.height - this.height * 0.5
            //if this.y goes above -100th px, equal it to -100th px
        ...
        draw(context) {
            ...
            //sx sy for coordinates where to start clipping
    ...
    class Layer {
        ...
        update() {
            //for giving that moving bakcground vibee
    ...
    class UI {
        ...
        draw(context) {
            context.save()//saves the version that doesnt have shadow
            ...
            context.restore()//and applies that saves version
        }
    }
    class Game {
        ...
        update(deltaTime) {
            ...
            //for preventing our player's character is on the top of layer4
                ...
                this.player.projectiles.forEach(projectile => {
                    if (this.checkCollision(projectile, enemy)) {
                        ...
                        if (enemy.lives <= 0) {
                            ...
                            for (let i = 0; i < 5; i++) {
                                if (enemy.type === "hive") { this.enemies.push(new Drone(this, enemy.x + Math.random() * enemy.width, enemy.y + Math.random() * enemy.height * 0.5)) }
